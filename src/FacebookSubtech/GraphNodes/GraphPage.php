...
class GraphPage extends GraphObject
{
    ...
    protected static $graphObjectMap = [
        'best_page' => '\FacebookSubtech\GraphNodes\GraphPage',
        'global_brand_parent_page' => '\FacebookSubtech\GraphNodes\GraphPage',
        'location' => '\FacebookSubtech\GraphNodes\GraphLocation',
    ];
