 ...
 *
 */
namespace  FacebookSubtech\GraphNodes;
...
class GraphUser extends GraphObject
{
    ...
    protected static $graphObjectMap = array(
        'hometown' => '\FacebookSubtech\GraphNodes\GraphPage',
        'location' => '\FacebookSubtech\GraphNodes\GraphPage',
        'significant_other' => '\FacebookSubtech\GraphNodes\GraphUser',
        'picture' => '\FacebookSubtech\GraphNodes\GraphPicture',
    );
